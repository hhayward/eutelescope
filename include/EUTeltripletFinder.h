...
#ifndef EUTeltripletFinder_H
#define	EUTeltripletFinder_H
...
namespace eutelescope {
	class EUTeltripletFinder {
	private:
		DISALLOW_COPY_AND_ASSIGN(EUTeltripletFinder) // prevent users from making (default) copies of processors
	public:
		EUTeltripletFinder();
		~EUTeltripletFinder();
		//GETTERS
